...
def calculate():
    ...
    if all_positive_numbers([equity_balance,exp_return,prob_win,prob_loss]):
        ...
        st.session_state["position_fractional_kelly"]= locale.currency(int(position_fractional_kelly),grouping=True).split('.')[0]
        ...
        st.session_state["pos_risk"]= locale.currency(pos_risk,grouping=True).split('.')[0]
